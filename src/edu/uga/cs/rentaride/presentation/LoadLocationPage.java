 ...
 */
@WebServlet("LoadLocationPage")
public class LoadLocationPage extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private Configuration cfg;
    static String templateDir = "/WEB-INF/templates";
    String destination = "locations.ftl";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            throw new ServletException("LoadLocationPage.doGet: Can't load template in: " + templateDir + ": " + e.toString());
        }
