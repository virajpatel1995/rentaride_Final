 ...
 <!--Login -->
		...
		<div class="login-screen">
			...
			<div class="login-form">
				...
				<label class="login-field-icon fui-user" for="contact-name"></label>
				</div>
                
                <div class="control-group">
				<input type="text" class="login-field" value="" placeholder="Email" id="login-name">
				<label class="login-field-icon fui-user" for="contact-email"></label>
				</div>
                
                <div class="control-group">
                <textarea type="text" class="login-field" value="" placeholder="Message" id="login-name" style="height:200px; width: 250px;"></textarea>
                    
                <label class="login-field-icon fui-user" for="contact-message"></label>
				</div>
				...
				<a class="btn btn-primary btn-large btn-block" href="#">Send</a>
