...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="carName" name="locationName" type="text" placeholder="Location Name" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="carType" name="locationAddress" type="text" placeholder="Address" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="carColor" name="locationCapacity" type="text" placeholder="Capacity" class="form-control input-md" required="">
                  ...
                  <div class="row">
                  <button type="submit" class="buttonx">Add Rental Location</button>
              </div>
              </div>
              <div class="col-xs-1"></div>
          </div>
